...
<body>
    ...
    <div class="container1"><br><br><br><br><br>
        <center>
            <h1 class="heading">ENTER DETAILS OF DAY </h1>
        </center>
        <div class="container2">
            ...
            <form name="User_inp_date_form" action="" method="POST" onsubmit="return validate_inp()">
                <input class="in1" DATE id="datepicker" onchange="checkDate()" name="user_date" type="date"
                    required=""><br>
            ...
            if (isset($_POST['Date_sub'])) {
                ...
                $sql = "select * from date_table where space_id = '$space_id' and Date = '$User_date'";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    $sql = "insert into i (space_id,User_id,Date,Start_time,End_time) values('$space_id','$User_ID','$User_date','$st','$et')";
                    ...
                    if ($_SESSION['no_of_pages'] == 0) {
                        echo "<script>  window.location.href = 'Total_cost.php?space_id=$space_id' </script>";
                    }

                } else {
                    $sql = "insert into aud_temp (space_id,User_id,Date,Start_time,End_time) values('$space_id','$User_ID','$User_date','$st','$et')";
