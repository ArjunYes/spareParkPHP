...
<body>
    <br>
    <center>
        <h1 class="heading">AVAILABLE DATES FOR NEXT 60 DAYS</h1>
    </center>
    ...
    <div class="container">
        ...
        $period = new DatePeriod(
            ...
            // Define the intervals as Periods of 1 Day
        ...
        foreach ($date as $element) {
            ...
            <div class="box1">
                ...
                $sql = "select * from date_table where space_id= '$space_id'";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($element == $Date) {
                            ...
                            ?>
                            <b>
                                <font color="red">Date not available</font>
                            </b>
                            <?php
