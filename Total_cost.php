...
<body>
    ...
    <div class="container1"><br><br><br><br><br>
        <center>
            <h1 class="heading"> THE DETAILS OF CURRENT TRANSACTION </h1>
        </center>
        <div class="container2">
            ...
            $sql = "select * from aud_temp where space_id = '$space_id' and User_id = '$User_ID'";
            ...
            $sql2 = "select * from space where space_id = '$space_id'";
            ...
            <button class="btn1" onclick=" window.location.href = 'Billing.php?space_id= <?php echo $space_id ?> ' ">
                BOOK AND PAY <?php echo $Total_cost ?> NOW</button>
